...
void DMA2_Stream1_IRQHandler(void) {
	...
	SuperConds.UC_1 = ADCConvertedValue1[0]*3230/0xFFF; 
	SuperConds.UC_2 = ADCConvertedValue1[1]*3230/0xFFF; 
	SuperConds.UC_3 = ADCConvertedValue1[2]*3230/0xFFF;
	SuperConds.UC_4 = ADCConvertedValue1[3]*3230/0xFFF;
